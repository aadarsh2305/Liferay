...
public interface DesignationLocalService
	...
	public Designation createDesignation(long Id);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Designation deleteDesignation(long Id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Designation fetchDesignation(long Id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Designation getDesignation(long Id) throws PortalException;
