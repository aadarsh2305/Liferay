...
/**
 * Provides the local service interface for State. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see StateLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.test.serviceBuilder.service.impl.StateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the state local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StateLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<State> findByCountryId(long countryId) throws SystemException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<State> getStatesByUuidAndCompanyId(String uuid, long companyId);
