...
public class DesignationUtil {
	...
	public static Designation findByUuid_First(
		...
		throws com.test.serviceBuilder.exception.NoSuchDesignationException {
	 ...
	 */
	public static Designation create(long Id) {
	 ...
	 * @throws NoSuchDesignationException if a designation with the primary key could not be found
	 */
	public static Designation remove(long Id)
		throws com.test.serviceBuilder.exception.NoSuchDesignationException {
	 ...
	 * @throws NoSuchDesignationException if a designation with the primary key could not be found
	 */
	public static Designation findByPrimaryKey(long Id)
		throws com.test.serviceBuilder.exception.NoSuchDesignationException {
	 ...
	 */
	public static Designation fetchByPrimaryKey(long Id) {
