...
/**
 * The table class for the &quot;Service_Builder_Department&quot; database table.
 *
...
public class DepartmentTable extends BaseTable<DepartmentTable> {
	...
	public final Column<DepartmentTable, Long> Id = createColumn(
		"Id", Long.class, Types.BIGINT, Column.FLAG_PRIMARY);
	public final Column<DepartmentTable, String> Name = createColumn(
		"Name", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<DepartmentTable, String> Head = createColumn(
		"Head", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);

	private DepartmentTable() {
		super("Service_Builder_Department", DepartmentTable::new);
	}
