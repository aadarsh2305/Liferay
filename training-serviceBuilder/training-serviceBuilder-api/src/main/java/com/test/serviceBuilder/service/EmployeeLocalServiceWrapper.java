...
public class EmployeeLocalServiceWrapper
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.Employee addEmployee(
		com.test.serviceBuilder.model.Employee employee) {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.Employee createEmployee(long Id) {
		return _employeeLocalService.createEmployee(Id);
	}
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.Employee deleteEmployee(
		com.test.serviceBuilder.model.Employee employee) {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.Employee deleteEmployee(long Id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _employeeLocalService.deleteEmployee(Id);
	}
	...
	@Override
	public com.test.serviceBuilder.model.Employee fetchEmployee(long Id) {
		return _employeeLocalService.fetchEmployee(Id);
	}
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.Employee fetchEmployeeByUuidAndGroupId(
	...
	@Override
	public java.util.List<com.test.serviceBuilder.model.Employee>
		findByBranchId(long branchId) {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.Employee getEmployee(long Id)
		throws com.liferay.portal.kernel.exception.PortalException {

		return _employeeLocalService.getEmployee(Id);
	}

	@Override
	public java.util.List<Object[]> getEmployeeBeanNameById(long id) {
		return _employeeLocalService.getEmployeeBeanNameById(id);
	}
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.Employee getEmployeeByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.test.serviceBuilder.model.Employee> getEmployees(
		int start, int end) {
	...
	@Override
	public java.util.List<Object[]> getEmployeesByName(String Name) {
		return _employeeLocalService.getEmployeesByName(Name);
	}
	...
	public java.util.List<com.test.serviceBuilder.model.Employee>
		getEmployeesByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<com.test.serviceBuilder.model.Employee> orderByComparator) {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.Employee updateEmployee(
		com.test.serviceBuilder.model.Employee employee) {
