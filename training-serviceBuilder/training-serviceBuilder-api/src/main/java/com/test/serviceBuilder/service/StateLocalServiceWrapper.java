...
public class StateLocalServiceWrapper
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.State addState(
		com.test.serviceBuilder.model.State state) {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.State createState(long stateId) {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.State deleteState(long stateId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.State deleteState(
		com.test.serviceBuilder.model.State state) {
	...
	@Override
	public com.test.serviceBuilder.model.State fetchState(long stateId) {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.State fetchStateByUuidAndGroupId(
	...
	@Override
	public java.util.List<com.test.serviceBuilder.model.State> findByCountryId(
			long countryId)
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.State getState(long stateId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.State getStateByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.test.serviceBuilder.model.State> getStates(
		int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<com.test.serviceBuilder.model.State>
	...
	public java.util.List<com.test.serviceBuilder.model.State>
		getStatesByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<com.test.serviceBuilder.model.State> orderByComparator) {
	 ...
	 */
	@Override
	public com.test.serviceBuilder.model.State updateState(
		com.test.serviceBuilder.model.State state) {
