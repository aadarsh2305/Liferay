...
public class DepartmentUtil {
	 ...
	 * @return the matching department, or <code>null</code> if a matching department could not be found
	 */
	public static Department fetchByName(String Name) {
	 ...
	 * @return the matching department, or <code>null</code> if a matching department could not be found
	 */
	public static Department fetchByName(String Name, boolean useFinderCache) {
	 ...
	 * @return the department that was removed
	 */
	public static Department removeByName(String Name)
		throws com.test.serviceBuilder.exception.NoSuchDepartmentException {
	 ...
	 * @throws NoSuchDepartmentException if a department with the primary key could not be found
	 */
	public static Department remove(long Id)
		throws com.test.serviceBuilder.exception.NoSuchDepartmentException {
	 ...
	 * @throws NoSuchDepartmentException if a department with the primary key could not be found
	 */
	public static Department findByPrimaryKey(long Id)
		throws com.test.serviceBuilder.exception.NoSuchDepartmentException {
	 ...
	 */
	public static Department fetchByPrimaryKey(long Id) {
