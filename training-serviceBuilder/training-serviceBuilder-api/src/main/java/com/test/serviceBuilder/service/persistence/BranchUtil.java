...
public class BranchUtil {
	...
	public static Branch findByUuid_First(
		...
		throws com.test.serviceBuilder.exception.NoSuchBranchException {
	 ...
	 * @throws NoSuchBranchException if a matching branch could not be found
	 */
	public static Branch findByNameAndId(String Name)
		throws com.test.serviceBuilder.exception.NoSuchBranchException {

		return getPersistence().findByNameAndId(Name);
	}
	 ...
	 * @return the matching branch, or <code>null</code> if a matching branch could not be found
	 */
	public static Branch fetchByNameAndId(String Name) {
		return getPersistence().fetchByNameAndId(Name);
	}
	 ...
	 * @return the matching branch, or <code>null</code> if a matching branch could not be found
	 */
	public static Branch fetchByNameAndId(String Name, boolean useFinderCache) {
		return getPersistence().fetchByNameAndId(Name, useFinderCache);
	}
	 ...
	 * @return the branch that was removed
	 */
	public static Branch removeByNameAndId(String Name)
		throws com.test.serviceBuilder.exception.NoSuchBranchException {

		return getPersistence().removeByNameAndId(Name);
	}
	 ...
	 * @return the number of matching branches
	 */
	public static int countByNameAndId(String Name) {
		return getPersistence().countByNameAndId(Name);
	}
