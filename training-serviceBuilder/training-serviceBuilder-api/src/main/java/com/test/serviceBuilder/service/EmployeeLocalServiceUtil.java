 ...
 * <code>com.test.serviceBuilder.service.impl.EmployeeLocalServiceImpl</code> and
...
public class EmployeeLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.test.serviceBuilder.service.impl.EmployeeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Employee deleteEmployee(long Id) throws PortalException {
	...
	public static Employee fetchEmployee(long Id) {
		return getService().fetchEmployee(Id);
	}
	...
	public static List<Object[]> getEmployeeBeanNameById(long id) {
		return getService().getEmployeeBeanNameById(id);
	}
	...
	public static List<Object[]> getEmployeesByName(String Name) {
		return getService().getEmployeesByName(Name);
	}
