...
/**
 * The table class for the &quot;Service_Builder_Designation&quot; database table.
 *
...
public class DesignationTable extends BaseTable<DesignationTable> {
	...
	public final Column<DesignationTable, Long> Id = createColumn(
		"Id", Long.class, Types.BIGINT, Column.FLAG_PRIMARY);
	public final Column<DesignationTable, String> Name = createColumn(
		"Name", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);

	private DesignationTable() {
		super("Service_Builder_Designation", DesignationTable::new);
	}
