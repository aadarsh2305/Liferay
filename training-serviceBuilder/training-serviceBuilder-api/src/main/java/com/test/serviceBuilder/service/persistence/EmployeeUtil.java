...
public class EmployeeUtil {
	...
	public static Employee findByUuid_First(
		...
		throws com.test.serviceBuilder.exception.NoSuchEmployeeException {
	...
	public static Employee[] findBydepartmentId_PrevAndNext(
		...
		return getPersistence().findBydepartmentId_PrevAndNext(
			Id, departmentId, orderByComparator);
	}
