 ...
 * <code>com.test.serviceBuilder.service.impl.DesignationLocalServiceImpl</code> and
...
public class DesignationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.test.serviceBuilder.service.impl.DesignationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Designation createDesignation(long Id) {
		return getService().createDesignation(Id);
	}
	 ...
	 */
	public static Designation deleteDesignation(long Id)
		throws PortalException {

		return getService().deleteDesignation(Id);
	}
	...
	public static Designation fetchDesignation(long Id) {
		return getService().fetchDesignation(Id);
	}
	 ...
	 * @throws PortalException if a designation with the primary key could not be found
	 */
	public static Designation getDesignation(long Id) throws PortalException {
		return getService().getDesignation(Id);
	}
