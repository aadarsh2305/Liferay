...
import com.test.serviceBuilder.service.CityService;
import com.test.serviceBuilder.service.CityServiceUtil;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.test.serviceBuilder.service.impl.CityServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.test.serviceBuilder.service.impl.CityServiceImpl
 * @generated
 */
public abstract class CityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CityService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CityServiceUtil</code>.
	 */
	@Deactivate
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setServiceUtilService(cityService);
	}
	...
	private void _setServiceUtilService(CityService cityService) {
		try {
			Field field = CityServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, cityService);
		}
	...
	@Reference
	protected com.test.serviceBuilder.service.CityLocalService cityLocalService;
