...
import com.test.serviceBuilder.exception.NoSuchCityException;
import com.test.serviceBuilder.model.City;
import com.test.serviceBuilder.model.CityTable;
import com.test.serviceBuilder.model.impl.CityImpl;
import com.test.serviceBuilder.model.impl.CityModelImpl;
import com.test.serviceBuilder.service.persistence.CityPersistence;
import com.test.serviceBuilder.service.persistence.CityUtil;
...
public class CityPersistenceImpl
	...
	public City findByUUID_G(String uuid, long groupId)
		...
		City city = fetchByUUID_G(uuid, groupId);
	...
	public City fetchByUUID_G(
		...
		if (result instanceof City) {
			...
			if (!Objects.equals(uuid, city.getUuid()) ||
				(groupId != city.getGroupId())) {
	...
	public City removeByUUID_G(String uuid, long groupId)
		...
		City city = findByUUID_G(uuid, groupId);
	...
	public void cacheResult(City city) {
		...
		finderCache.putResult(
			...
			new Object[] {city.getUuid(), city.getGroupId()}, city);
	}
	...
	protected void cacheUniqueFindersCache(CityModelImpl cityModelImpl) {
		Object[] args = new Object[] {
			cityModelImpl.getUuid(), cityModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByUUID_G, args, cityModelImpl);
	}
