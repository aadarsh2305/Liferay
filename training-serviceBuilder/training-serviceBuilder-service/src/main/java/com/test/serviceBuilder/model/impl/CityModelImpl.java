...
import com.test.serviceBuilder.model.CityModel;
...
/**
 * The base model implementation for the City service. Represents a row in the &quot;Service_Builder_City&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class CityModelImpl extends BaseModelImpl<City> implements CityModel {
	 ...
	 */
	public static final String TABLE_NAME = "Service_Builder_City";

	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"groupId", Types.BIGINT},
		{"companyId", Types.BIGINT}, {"userId", Types.BIGINT},
		{"userName", Types.VARCHAR}, {"createDate", Types.TIMESTAMP},
		{"modifiedDate", Types.TIMESTAMP}, {"cityId", Types.BIGINT},
		{"cityName", Types.VARCHAR}, {"stateId", Types.BIGINT}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table Service_Builder_City (uuid_ VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,cityId LONG not null primary key,cityName VARCHAR(75) null,stateId LONG)";

	public static final String TABLE_SQL_DROP =
		"drop table Service_Builder_City";

	public static final String ORDER_BY_JPQL = " ORDER BY city.cityName ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Service_Builder_City.cityName ASC";
	 ...
	 */
	@Deprecated
	public static final long CITYNAME_COLUMN_BITMASK = 16L;
	...
	static {
		...
		attributeGetterFunctions.put("cityName", City::getCityName);
		attributeSetterBiConsumers.put(
			"cityName", (BiConsumer<City, String>)City::setCityName);
		attributeGetterFunctions.put("stateId", City::getStateId);
		attributeSetterBiConsumers.put(
			"stateId", (BiConsumer<City, Long>)City::setStateId);
	...
	public City cloneWithOriginalValues() {
		...
		cityImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		cityImpl.setGroupId(this.<Long>getColumnOriginalValue("groupId"));
		...
		cityImpl.setCityName(this.<String>getColumnOriginalValue("cityName"));
		cityImpl.setStateId(this.<Long>getColumnOriginalValue("stateId"));
