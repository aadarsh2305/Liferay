...
import com.test.serviceBuilder.model.DesignationModel;
...
/**
 * The base model implementation for the Designation service. Represents a row in the &quot;Service_Builder_Designation&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class DesignationModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "Service_Builder_Designation";
	...
	public static final String TABLE_SQL_CREATE =
		"create table Service_Builder_Designation (uuid_ VARCHAR(75) null,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,Id LONG not null primary key,Name VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP =
		"drop table Service_Builder_Designation";

	public static final String ORDER_BY_JPQL = " ORDER BY designation.Id ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY Service_Builder_Designation.Id ASC";
	...
	static {
		...
		attributeGetterFunctions.put("uuid", Designation::getUuid);
		attributeSetterBiConsumers.put(
			"uuid", (BiConsumer<Designation, String>)Designation::setUuid);
		...
		attributeGetterFunctions.put("Id", Designation::getId);
		attributeSetterBiConsumers.put(
			"Id", (BiConsumer<Designation, Long>)Designation::setId);
		attributeGetterFunctions.put("Name", Designation::getName);
		attributeSetterBiConsumers.put(
			"Name", (BiConsumer<Designation, String>)Designation::setName);
	...
	public Object clone() {
		...
		designationImpl.setUuid(getUuid());
		...
		designationImpl.setId(getId());
		designationImpl.setName(getName());
	...
	public Designation cloneWithOriginalValues() {
		...
		designationImpl.setUuid(this.<String>getColumnOriginalValue("uuid_"));
		...
		designationImpl.setId(this.<Long>getColumnOriginalValue("Id"));
		designationImpl.setName(this.<String>getColumnOriginalValue("Name"));
	...
	public int compareTo(Designation designation) {
		...
		if (getId() < designation.getId()) {
			value = -1;
		}
		else if (getId() > designation.getId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public CacheModel<Designation> toCacheModel() {
		...
		designationCacheModel.uuid = getUuid();

		String uuid = designationCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			designationCacheModel.uuid = null;
		}
		...
		designationCacheModel.Id = getId();

		designationCacheModel.Name = getName();

		String Name = designationCacheModel.Name;

		if ((Name != null) && (Name.length() == 0)) {
			designationCacheModel.Name = null;
		}
