...
import com.test.serviceBuilder.exception.NoSuchDepartmentException;
import com.test.serviceBuilder.model.Department;
import com.test.serviceBuilder.model.DepartmentTable;
import com.test.serviceBuilder.model.impl.DepartmentImpl;
import com.test.serviceBuilder.model.impl.DepartmentModelImpl;
import com.test.serviceBuilder.service.persistence.DepartmentPersistence;
import com.test.serviceBuilder.service.persistence.DepartmentUtil;
...
public class DepartmentPersistenceImpl
	 ...
	 *
	 * @param Id the primary key of the current department
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Department[] findByUuid_PrevAndNext(
		...
		Department department = findByPrimaryKey(Id);
	 ...
	 */
	@Override
	public Department findByName(String Name) throws NoSuchDepartmentException {
	 ...
	 */
	@Override
	public Department fetchByName(String Name, boolean useFinderCache) {
	...
	public void cacheResult(Department department) {
		...
		finderCache.putResult(
			_finderPathFetchByName, new Object[] {department.getName()},
			department);
	}
	...
	protected void cacheUniqueFindersCache(
		...
		finderCache.putResult(
			_finderPathFetchByName, args, departmentModelImpl);
	}
	 ...
	 */
	@Override
	public Department remove(long Id) throws NoSuchDepartmentException {
	 ...
	 */
	@Override
	public Department fetchByPrimaryKey(long Id) {
