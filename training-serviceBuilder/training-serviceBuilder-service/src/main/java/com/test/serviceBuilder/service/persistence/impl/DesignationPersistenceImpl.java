...
import com.test.serviceBuilder.exception.NoSuchDesignationException;
import com.test.serviceBuilder.model.Designation;
import com.test.serviceBuilder.model.DesignationTable;
import com.test.serviceBuilder.model.impl.DesignationImpl;
import com.test.serviceBuilder.model.impl.DesignationModelImpl;
import com.test.serviceBuilder.service.persistence.DesignationPersistence;
import com.test.serviceBuilder.service.persistence.DesignationUtil;
...
public class DesignationPersistenceImpl
	 ...
	 *
	 * @param Id the primary key of the current designation
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	public Designation[] findByUuid_PrevAndNext(
		...
		Designation designation = findByPrimaryKey(Id);
	 ...
	 */
	@Override
	public List<Designation> findByName(String Name, int start, int end) {
	...
	public Designation findByName_First(
		...
		Designation designation = fetchByName_First(Name, orderByComparator);
	...
	public Designation fetchByName_First(
		...
		List<Designation> list = findByName(Name, 0, 1, orderByComparator);
	...
	public Designation findByName_Last(
		...
		Designation designation = fetchByName_Last(Name, orderByComparator);
	...
	public Designation[] findByName_PrevAndNext(
		...
		try {
			...
			array[0] = getByName_PrevAndNext(
				session, designation, Name, orderByComparator, true);

			array[1] = designation;

			array[2] = getByName_PrevAndNext(
				session, designation, Name, orderByComparator, false);
	...
	protected Designation getByName_PrevAndNext(
		Session session, Designation designation, String Name,
		OrderByComparator<Designation> orderByComparator, boolean previous) {
	...
	private static final String _FINDER_COLUMN_NAME_NAME_3 =
		"(designation.Name IS NULL OR designation.Name = '')";
	 ...
	 */
	@Override
	public Designation remove(long Id) throws NoSuchDesignationException {
	 ...
	 */
	@Override
	public Designation findByPrimaryKey(long Id)
		throws NoSuchDesignationException {
	 ...
	 */
	@Override
	public Designation fetchByPrimaryKey(long Id) {
